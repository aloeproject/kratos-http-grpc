...
func (c *vehicleClient) GetVehicle(ctx context.Context, in *GetVehicleRequest, opts ...grpc.CallOption) (*GetVehicleReply, error) {
	out := new(GetVehicleReply)
	err := c.cc.Invoke(ctx, "/api.vehicle.v1.Vehicle/GetVehicle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVehicleServer) GetVehicle(context.Context, *GetVehicleRequest) (*GetVehicleReply, error) {
...
func _Vehicle_GetVehicle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.vehicle.v1.Vehicle/GetVehicle",
	}
...
var Vehicle_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.vehicle.v1.Vehicle",
