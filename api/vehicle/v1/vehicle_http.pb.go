...
func NewVehicleHandler(srv VehicleHandler, opts ...http1.HandleOption) http.Handler {
	...
	r.HandleFunc("/v1/vehicle/get/{id}", func(w http.ResponseWriter, r *http.Request) {
