...
func NewGRPCServer(c *conf.Server, tracer trace.TracerProvider, vehicle *service.VehicleService, logger log.Logger) *grpc.Server {
	...
	v1.RegisterVehicleServer(srv, vehicle)
	return srv
}
